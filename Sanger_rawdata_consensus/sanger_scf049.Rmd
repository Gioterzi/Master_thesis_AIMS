...
f_all <- sort(list.files(path = "/Users/bross/Desktop/AIMS/Analysis/sanger_analysis", pattern = "F.txt", full.names = TRUE))

r_all <- sort(list.files(path = "/Users/bross/Desktop/AIMS/Analysis/sanger_analysis", pattern = "R.txt", full.names = TRUE))
...
```{r}
psba_F <- sort(list.files(path = "/Users/bross/Desktop/AIMS/Analysis/sanger_analysis", pattern = "psbA_F.txt", full.names = TRUE))

psba_R <- sort(list.files(path = "/Users/bross/Desktop/AIMS/Analysis/sanger_analysis", pattern = "psbA_R.txt", full.names = TRUE))
